...
{
const std::string FORMAT("<html><head><title>Not Found</title></head><body><h1>Not Found</h1><h2>%s</h2></body></html>");

    std::string text =
    boost::str( boost::format(FORMAT) %  request_path);
    return text;
}
...
void request_handler::handle_request(const request& req, reply& rep)
{
      ...
      || request_path.find("..") != std::string::npos)
  {
    ...
    on_request(req, rep, doc_root_, request_path);
}
