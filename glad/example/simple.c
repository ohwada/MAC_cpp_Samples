...
// show OpenGL window
// original : https://raw.githubusercontent.com/Dav1dde/glad/master/example/c/simple.c
...
{
    glClearColor(1.0f, 0.2f, 0.7f, 1.0f); // Pink
...
int main(int argc, char **argv)
{
   ...
   // if(gladLoadGL()) {
    ...
    if(!gladLoadGL()) {
        printf("gladLoadGL: Something went wrong! \n");
        exit(-1);
    }
