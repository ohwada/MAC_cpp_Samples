...
void histogram_image_rgba_fp(image2d_t img, int num_pixels_per_workitem, global uint *histogram)
{
    ...
    int group_indx = mad24((int)get_group_id(1), (int)get_num_groups(0), (int)get_group_id(0)) * 257 * 3;
    ...
    int tid = mad24(lid1, lsize0, lid0);
...
void histogram_image_rgba_unorm8(image2d_t img, int num_pixels_per_workitem, global uint *histogram)
{
    ...
    int group_indx = mad24((int)get_group_id(1), (int)get_num_groups(0), (int)get_group_id(0)) * 256 * 3;
