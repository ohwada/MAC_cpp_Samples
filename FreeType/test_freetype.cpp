 ...
 * FreeType Sample
 * 2020-03-01 K.OHWADA
 * original : https://www.freetype.org/freetype2/docs/tutorial/step3.html
 */

// read font file
// write font glyph image to file
 ...
 * createGlyphPixel
 */
Pixel32* createGlyphPixel(FT_Library &library,
                wchar_t ch,
                FT_Face &face,
                int size,
                ...
                float outlineWidth)
{
    ...
    Pixel32* pxl = createGlyphPixel(library,
                ch,
                face,
                size,
                fontCol,
 ...
 * writeGlyph
 */
void writeGlyph(FT_Library library, FT_Face face, wchar_t ch, std::string fileName)
{
    ...
    Pixel32* pxl = createGlyphPixel(library,
                ...
                face,
                100, // font size
                Pixel32(255, 90, 30),  // font color Cyan
                Pixel32(255, 255, 255), // outline color White
                3.0f, // outlineWidth
                imgWidth,
                imgHeight);

    bool ret= WriteTGA(fileName, pxl, imgWidth, imgHeight);

    if(ret){
        std::cout << "writeTGA: " << fileName << " ( " << imgWidth << " x " << imgHeight << " ) "<< std::endl;
    } else {
        std::cout << "writeTGA Faild: " << fileName << std::endl;
    }
...
int main(int argc,char **argv)
{
    ...
    std::cout << "Render letter of given font as a TGA image. " << std::endl;
  ...
  // Open up a font file.
  std::ifstream fontFile(font_file, std::ios::binary);
  if (fontFile)
  {
    ...
    writeGlyph(library, face,  L'A',  "test_a.tga");
    writeGlyph(library, face,  L'B',  "test_b.tga");
    writeGlyph(library, face,  L'C',  "test_c.tga");
    writeGlyph(library, face,  L'D',  "test_d.tga");
