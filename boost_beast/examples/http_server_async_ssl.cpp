...
// HTTP SSL server, asynchronous

// original : https://github.com/boostorg/beast/blob/develop/example/http/server/async-ssl/http_server_async_ssl.cpp
//
...
int main(int argc, char* argv[])
{
    ...
    int threads = std::max<int>(1, arg_hreads);
