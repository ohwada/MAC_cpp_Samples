...
// g++ https/https_client.cpp -std=c++11 `pkg-config --cflags --libs boost`  `pkg-config --cflags --libs openssl` -o client

// TODO:
// www.google.com
// Exception: stream truncated
...
int main(int argc, char** argv)
{
    ...
    if(argc == 7) {
       ...
       is_verify = (bool)stoi( argv[5] );
        ...
        std::cout <<
            "Usage: " << argv[0] <<" [host] [port] [target] [HTTP version: 1.0 or 1.1(default)] [verify] [file cert]\n" << endl;
    }
