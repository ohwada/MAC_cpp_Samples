...
bool  getRefreshTokenToFile(std::string postfileds, std::string file, std::string &ret_error, bool verbose);
bool  getAccessToken(std::string postfileds, std::string &ret_response, std::string &ret_error, bool verbose);
...
bool  getRefreshTokenToFile(std::string postfileds, std::string file, std::string &ret_error, bool verbose)
{
    ...
    std::string error;
    bool ret = http_post_to_file( URL_TOKEN, postfileds, file, error, verbose);
    if(!ret){
        ret_error = error;
        return false;
    }
...
bool ret = http_post_to_memory(URL_TOKEN, postfileds, response,  error, verbose);
