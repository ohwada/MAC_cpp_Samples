...
// reference : http://www.mega-nerd.com/libsndfile/tools/
...
{	spectrum *spec ;
	...
	*/
	spec->time_domain = (double *)calloc (2 * speclen + 1, sizeof (double)) ;
	spec->window = (double *)calloc (2 * speclen, sizeof (double)) ;
	spec->freq_domain = (double *)calloc (2 * speclen, sizeof (double)) ;
	spec->mag_spec = (double *)calloc (speclen + 1, sizeof (double)) ;
