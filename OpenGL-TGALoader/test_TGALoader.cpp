...
int main( int argc, char **argv )
{
	...
	cout << "OpenGL test TGALoader" << endl;
    ...
    string windowTitle = createWindowTitle(input);
	...
	Initialize(input);
	cout << "Initialize TGALoader Successfully" << endl;
...
string createWindowTitle(string input)
{
    ...
    string window_title =  "TGALoader: " + title;
