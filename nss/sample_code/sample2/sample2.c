//  gcc sample2.c `pkg-config --cflags --libs nss` 
...
int main(int argc, char **argv)
{
  ...
  rv2 = PK11_DigestFinal(EncContext, buf1+tmp1_outlen, (unsigned int *)&tmp2_outlen,
  ...
  rv1 = PK11_CipherOp(EncContext, buf2, &tmp1_outlen, sizeof(buf2),
                      buf1, result_len);
  rv2 = PK11_DigestFinal(EncContext, buf2+tmp1_outlen, (unsigned int *)&tmp2_outlen,
...
// Clear Data: Encrypt me!
// Encrypted Data: ca 61 45 4f 07 50 8c 21 bd 86 46 ee fd fa 3f 9f 
//Decrypted Data: Encrypt me!
