# Python: play Video
#f load  # Python: play Video file using QMediaPlayer
# play # Python: play Movie  using QVideoWidget
# Not support avi on Mac
#  2025-04-10  K.OHWADA
...
# end
    ...
    def print_supportedMimeTypes(self):
        print('supportedMimeTypes:')
        for mimetype in QMediaPlayer.supportedMimeTypes():
            print(mimetype)
# end
