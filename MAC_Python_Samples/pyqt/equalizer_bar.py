# https://github.com/Qt-Widgets/qtpythonwidgets/blob/master/equalizer_bar/equalizer_bar.py  
    ...
    def paintEvent(self, e):
        ...
        for b in range(self.n_bars):
            ...
            for n in range(n_steps_to_draw):
                ...
                left = int(self._padding + (step_x * b) + bar_width_space)
                top = int(self._padding + d_height - ((1 + n) * step_y) + bar_height_space)
                rect = QtCore.QRect(
                    left, top, int(bar_width), int(bar_height) )
                painter.fillRect(rect, brush)
