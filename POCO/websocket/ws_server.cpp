...
// original : https://github.com/pocoproject/poco/blob/devel/Net/samples/WebSocketServer/src/WebSocketServer.cpp
...
protected:
	...
	int main(const std::vector<std::string>& args)
	{
		...
		else
		{
			...
			unsigned short port = (unsigned short) config().getInt("WebSocketServer.port",  PORT);
