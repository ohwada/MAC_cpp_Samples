...
// example for how to refuse a POST request properly

// original : https://github.com/rboulton/libmicrohttpd/blob/master/src/examples/refuse_post_example.c
/*
...
#define BUSYPAGE "<html><head><title>Webserver busy</title></head><body><b>We are too busy to process POSTs right now.</b></body></html>"
...
main (int argc, char *const *argv)
{
  ...
  d = MHD_start_daemon (
    MHD_USE_INTERNAL_POLLING_THREAD | MHD_USE_DEBUG,
                        port,
                        NULL, NULL, (void *)&ahc_echo, (void *) askpage,
                        MHD_OPTION_END);
