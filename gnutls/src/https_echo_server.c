...
// HTTPS Echo Server with X.509 authentication


// reference : https://gnutls.org/manual/html_node/Echo-server-with-X_002e509-authentication.html#Echo-server-with-X_002e509-authentication
...
int main(int argc, char *argv[])
{
    ...
    const char KEYFILE[] = "cert/server.key";
    const char  CERTFILE[] = "cert/server.pem";
