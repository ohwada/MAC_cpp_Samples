...
// without music
// gcc main.c tetris.c util.c music.c  -o tetris -lncurses

// with music
// gcc main.c tetris.c util.c music.c  -o tetris_music  -DWITH_SDL   -lncurses  `pkg-config --cflags --libs sdl2`  -lSDL2_mixer
...
// with music
// gcc main.c tetris.c util.c music.c  -o tetris_music  -DWITH_SDL  `pkg-config --cflags --libs ncurses` `pkg-config --cflags --libs sdl2_mixer`


// change log 
// 2022-05-01
// add DELAY to adjust the speed of the game
// separated music processing into music.c
