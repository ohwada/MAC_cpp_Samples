 //ex_btrec
// Using a btree with both keys and record numbers
// This program shows how to store automatically numbered records in a btree database, 
// by setting its DB_RECNUM flag. 
// This variety of database can locate a record in two ways: //either by specifying the key, 
// or by specifying the dynamic logical “record number”
// the relative location of the record in thedatabase, 
// as in the line numbers of a text file.
...
// dynamically changing record number.


// gcc ex_btrec.c  `pkg-config --cflags --libs libdb`

// https://github.com/berkeleydb/libdb/blob/master/examples/c/ex_btrec.c
...
// recno #> 1
// k/d	0001addresser : resserdda1000
// next	0002cataract : tcaratac2000
// retrieved recno: 2
